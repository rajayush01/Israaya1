...
export const stories = [
  {
    ...
    excerpt:
      'A soft peach suit finished in textured organza, with resham and sequin work traced along the neckline and front split.',
    body: [
      'Komal Tara comes in a soft peach silk, easy to wear and easy to style, whether it\u2019s a summer morning or a formal event. The colour sits somewhere between subtle and striking, which is exactly what makes it work so well.',
  ...
  {
    slug: 'sitara-chandni',
    title: 'Sitara Chandni',
    chapter: 'Chapter I · 03',
    excerpt:
      'A white staple Anarkali inspired by the way moonlight sits on everything it touches, finished in silver zardozi.',
    body: [
      'Sitara Chandni is that one white staple Anarkali you\u2019ll keep coming back to. Crafted in pure Chanderi, this three-piece set is inspired by the way moonlight sits on everything it touches — never loud, never fading into the background either, just quietly impossible to look away from.',
